...
1. **Trigger** — POST a request to [`/ai_outbound/requests`](/api-reference/ai_outbound/create) identifying the client (by `client_id` or `contact_number`) and the `purpose` of the outreach.
